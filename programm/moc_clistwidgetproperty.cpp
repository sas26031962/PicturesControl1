...
void cListWidgetProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<cListWidgetProperty *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (cListWidgetProperty::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cListWidgetProperty::showExecStatus)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (cListWidgetProperty::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cListWidgetProperty::showCurrentIndexPicture)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cListWidgetProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_cListWidgetProperty.data,
    qt_meta_data_cListWidgetProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
