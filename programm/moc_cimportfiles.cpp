...
void cImportFiles::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<cImportFiles *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (cImportFiles::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cImportFiles::showExecStatus)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (cImportFiles::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&cImportFiles::resetNavigation)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject cImportFiles::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_cImportFiles.data,
    qt_meta_data_cImportFiles,
    qt_static_metacall,
    nullptr,
    nullptr
} };
