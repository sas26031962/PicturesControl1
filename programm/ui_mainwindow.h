...
public:
    ...
    QAction *actionSearchFreshRecords;
    QAction *actionSearchYesYes;
    ...
    QPushButton *pushButtonSearchYesYes;
    QWidget *tab_7;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSearchFreshRecords = new QAction(MainWindow);
        actionSearchFreshRecords->setObjectName(QStringLiteral("actionSearchFreshRecords"));
        actionSearchYesYes = new QAction(MainWindow);
        actionSearchYesYes->setObjectName(QStringLiteral("actionSearchYesYes"));
        ...
        groupBoxMemo = new QGroupBox(centralWidget);
        groupBoxMemo->setObjectName(QStringLiteral("groupBoxMemo"));
        groupBoxMemo->setGeometry(QRect(10, 510, 581, 51));
        lineEditMemo = new QLineEdit(groupBoxMemo);
        lineEditMemo->setObjectName(QStringLiteral("lineEditMemo"));
        lineEditMemo->setGeometry(QRect(10, 20, 521, 23));
        pushButtonMemo = new QPushButton(groupBoxMemo);
        pushButtonMemo->setObjectName(QStringLiteral("pushButtonMemo"));
        pushButtonMemo->setGeometry(QRect(540, 20, 31, 23));
        ...
        pushButtonSearchYesYes = new QPushButton(tab_6);
        pushButtonSearchYesYes->setObjectName(QStringLiteral("pushButtonSearchYesYes"));
        pushButtonSearchYesYes->setGeometry(QRect(120, 280, 91, 23));
        ...
        groupBoxNavigation = new QGroupBox(centralWidget);
        groupBoxNavigation->setObjectName(QStringLiteral("groupBoxNavigation"));
        groupBoxNavigation->setGeometry(QRect(10, 380, 271, 131));
        ...
        menuSearch->addAction(actionSearchYesYes);
        ...
        menuSearch->addAction(actionSearchFreshRecords);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionSearchFreshRecords->setText(QApplication::translate("MainWindow", "SearchFreshRecords", 0));
        actionSearchYesYes->setText(QApplication::translate("MainWindow", "SearchYesYes", 0));
        labelIncomingListCaption->setText(QApplication::translate("MainWindow", "Incoming tag", 0));
        groupBoxMemo->setTitle(QApplication::translate("MainWindow", "Memo", 0));
        ...
        pushButtonSearchYesYes->setText(QApplication::translate("MainWindow", "Search YES YES", 0));
        ...
        groupBoxNavigation->setTitle(QApplication::translate("MainWindow", "Navigation", 0));
