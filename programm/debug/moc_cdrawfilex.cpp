...
void cDrawFilex::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        cDrawFilex *_t = static_cast<cDrawFilex *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (cDrawFilex::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&cDrawFilex::foundMissingFile)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject cDrawFilex::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cDrawFilex.data,
      qt_meta_data_cDrawFilex,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cDrawFilex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cDrawFilex.stringdata0))
        return static_cast<void*>(const_cast< cDrawFilex*>(this));
