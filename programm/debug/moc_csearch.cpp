...
void cSearch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        cSearch *_t = static_cast<cSearch *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (cSearch::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&cSearch::showExecStatus)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (cSearch::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&cSearch::showCurrentIndexPicture)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject cSearch::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cSearch.data,
      qt_meta_data_cSearch,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cSearch::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cSearch.stringdata0))
        return static_cast<void*>(const_cast< cSearch*>(this));
